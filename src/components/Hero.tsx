...
const Hero = () => {
  return (
    <div className="w-full lg:h-[90vh] h-auto bg-amber-50 flex items-center relative sm:overflow-hidden">
      <div className="container mx-auto grid lg:grid-cols-2 grid-cols-1 bg-amber-50 py-16">
        <div className="content space-y-10">
          <h1 className="font-[700] lg:text-6xl text-4xl">
            Instant cash for gift cards & crypto exchange
          </h1>
          <p className="text-xl">
            Enjoy fast & secured transactions <br className="hidden lg:block" />{" "}
            with amazing rates
          </p>
